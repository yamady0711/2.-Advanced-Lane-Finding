...
\documentclass[11pt]{article}
    ...
    \def\lt{<}
    % Document parameters
    \title{writeup for 2nd submission}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}3}]:} Text(0.5,1,'Undistorted Image')
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}5}]:} Text(0.5,1,'Undistorted Image')
\end{Verbatim}
...
I tried sobel gradients and HSL,Luv,Lab color channel by tweaking lower
and higher thresholds.

Especially, L-channel from Luv is aiming for white lane line, b-channel
from Lab is aiming for yellow lane line.
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} Text(0.5,1,'HLS S-Channel')
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} Text(0.5,1,'Luv L-Channel')
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}13}]:} Text(0.5,1,'Lab b-Channel')
\end{Verbatim}
...
Jupyter notebook. The unwarp() function takes as inputs an gray image
(\texttt{gray}), source (\texttt{src}) and destination (\texttt{dst})
points.

I assumed that the camera position remain constant and that the road in
the videos will remain relatively flat. So I selected source and
destination points considering straight\_lines image in
\texttt{test\_images} folder for reference.
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}14}]:} Text(0.5,1,'Unwarped Image')
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}17}]:} (720, 0)
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}18}]:} (0, 1280)
\end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}19}]:} (720, 0)
\end{Verbatim}
...
This step is in the code cells \#19 and \#20. By using the inverse
perspective matrix \texttt{Minv} which was derived in the ``Perspective
transform'' section, left and right lane lines and area between them are
drwawn on the original image with \texttt{cv2.warpPerspective()}. The
image below is an example of the results of the draw\_lane function:
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}22}]:} <matplotlib.image.AxesImage at 0x7f8cdd290240>
\end{Verbatim}
